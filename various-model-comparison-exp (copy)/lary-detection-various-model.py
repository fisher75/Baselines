...
class ExGAN():
    def __init__(self, model_name):
        ...
        self.b1 = 0.5
        self.b2 = 0.999
        self.log_write = open("./results/log_%s_results_without_aug.txt" % self.model_name, "w")
            ...
            for batch, (imgA, labelA) in enumerate(self.dataloader, 1):
                ...
                if batch % 200 == 0:
                    ...
                    if testAcc > best_accuracy:
                        ...
                        log_write_record = open("./results/log_%s_train_record.txt" % self.model_name, "w")
...
def main():
    ...
    models_list = ['AlexNet', 'VGG11', 'VGG16', 'ResNet18', 'ResNet50', 'DenseNet', 'Mobilenet2', "SqueezeNet1_0", 'ShuffleNet_v2_x1_0', 'ViT', 'Swin-Transformer'] # all
