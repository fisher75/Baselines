...
class ResNetModel(nn.Module):
    def __init__(self, resnet_model, dim):
        super(ResNetModel, self).__init__()
        self.classifiers = []
        self.conv = resnet_model
...
class CNNExperiment:
    def __init__(self):
        ...
        resnet_model.fc = nn.Sequential()  # Removing the final layer
        self.dim = resnet_model.fc.in_features
        self.model = ResNetModel(resnet_model, self.dim)
    ...
    # train and test methods remain unchanged
    def train(self):
